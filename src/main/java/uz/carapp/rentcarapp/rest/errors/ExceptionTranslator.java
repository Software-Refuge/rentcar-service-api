...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrRespModel> handleUserAssignedToCourseSection(BadRequestCustomException exception) {
        exception.printStackTrace();
        log.info(exception.getDefaultMessage(), exception);
    ...
    public ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest request) {
        ...
        ErrRespModel errRespModel = new ErrRespModel(HttpStatus.INTERNAL_SERVER_ERROR,
                ex.getMessage(),
                LocalDateTime.now()
                );

        return new ResponseEntity<>(errRespModel, HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof uz.carapp.rentcarapp.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (ex instanceof uz.carapp.rentcarapp.service.EmailAlreadyUsedException) return (ProblemDetailWithCause) new EmailAlreadyUsedException()
            .getBody();
        if (ex instanceof uz.carapp.rentcarapp.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "uz.momoit.lms");
    }
}
